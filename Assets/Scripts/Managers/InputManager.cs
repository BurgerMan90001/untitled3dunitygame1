...
public class InputManager : MonoBehaviour, PlayerInputActions.IPlayerActions, PlayerInputActions.ICombatActions
{
    ...
    [SerializeField] private GameInput _camera;
    private IGameCamera _gameCamera;
    [SerializeField] private GameInput _player;
    ...
    private void Awake()
    {
        ...
        if (_camera.TryGetComponent(out IGameCamera gameCamera))
        {
        ...
        if (_player.TryGetComponent(out IPlayerMovement playerMovement))
        {
