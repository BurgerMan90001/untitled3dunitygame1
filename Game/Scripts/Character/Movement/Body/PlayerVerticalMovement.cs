...
public class VerticalMovement
{
    ...
    public void CrouchBody(Rigidbody rigidBody, float crouchYScale, bool isGrounded)
    {
        ...
        _body.parent.localScale = new Vector3(_body.parent.localScale.x, crouchYScale, _body.parent.localScale.z);
    ...
    public void UnCrouchBody(float originalYScale, bool isGrounded)
    {
        ...
        _body.parent.localScale = new Vector3(_body.parent.localScale.x, originalYScale, _body.parent.localScale.z);
        IsCrouched = false;
    }
